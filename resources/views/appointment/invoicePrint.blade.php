    ...
    <div class='bg-white w-full rounded-lg shadow-md p-8'>
        ...
        <form action="{{ route('appointments.update', $appointment->id) }}" method="POST">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-2">
                ...
                <div class="mb-4">
                    <label for="firstName" class="form-label font-medium text-gray-700 block mb-2">Transaction Number:</label>
                    <input type="text" class="form-control block w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500" id="transaction" name="transaction" value="{{ old('transaction_number', $appointment->transaction_number) }}" required>
                </div>
