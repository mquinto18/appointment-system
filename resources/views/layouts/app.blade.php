    ...
    <div class="flex flex-row">
        <div class="flex flex-col w-64 h-screen fixed overflow-y-auto bg-white border-r rtl:border-r-0 rtl:border-l dark:bg-gray-900 dark:border-gray-700">
            <div class="sidebar text-center bg-white">
                ...
                <div class='mx-4'>
                    ...
                    <div class="relative">
                        ...
                        <div id="profile-dropdown" class="hidden relative w-full text-left rounded-md mt-1 space-y-1 px-2 py-1">
                            <a href="{{ route('profile.settings') }}" class="block px-4 py-2 rounded hover:bg-[#0074C8] hover:text-white"><li>Profile Settings</li></a>
                            <a href="{{ route('security.settings') }}" class="block px-4 py-2 rounded hover:bg-[#0074C8] hover:text-white"><li>Security Settings</li></a>
                        </div>
                    </div>
                ...
                <div class='mx-4 my-2 rounded-md py-2 text-center bg-[#0074C8] text-white'>
