    ...
    <div class='bg-white w-full -mt-5 rounded-lg shadow-md p-8'>
        <div>
            ...
            <div>
                ...
                <!-- Image Upload Form -->
                <form action="{{ route('profile.updateDoctor_picture') }}" method="POST" enctype="multipart/form-data" class="mt-4">
                    @csrf
        ...
        <form method="POST" action="{{ route('doctorProfile.update') }}" class="grid grid-cols-3 gap-4 mt-5">
            @csrf
            @method('PUT')
