...
<div>
    <h1 class='font-medium text-2xl ml-3'>User</h1>
</div>
...
<div class='mx-10 -m-16'>
    <div class='flex justify-between mb-2'>
            <span class='text-[20px] text-white font-medium'>All User | {{$totalUsers}} </span>
            <div class='bg-white px-3 py-2 rounded-md cursor-pointer' data-bs-toggle="modal" data-bs-target="#addAdminModal">
                ...
                <a href="#" class='font-medium no-underline text-black' >Add new user</a>
            </div>
        </div>
        ...
        <div class="overflow-x-auto">
            ...
            <div class="flex justify-between items-center mb-4">
                ...
                <div class="flex items-center">
                    ...
                    <form method="GET" action="">
                        <input type="text" name="searchUser" value="{{ request('searchUser') }}" class="border border-gray-300 p-2 rounded" placeholder="Search">
            ...
            @if($users->count() > 0)
                ...
                <!-- Pagination -->
                <div class="mt-4">
                    {{ $users->appends(['searchUser' => request('searchUser')])->links() }}
                </div>
            @else
                <!-- If no admins found -->
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content p-0">
                <div class="modal-body text-center mb-5 mx-4">
                    ...
                    <h5 class="modal-title mb-3 text-[25px] font-bold" id="deleteAdminModalLabel">Delete User</h5>
...
<div class="modal fade" id="viewAdminModal" tabindex="-1" aria-labelledby="viewAdminModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="viewAdminModalLabel">User Details</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <div class="row">
